  ...
  render() {
    ...
    return (
      <View flex={1}>
        ...
        <TouchableOpacity style={styles.button} onPress={this.props.log}>
          <Image style={styles.image} source={IMAGES.plusSignMinimal} />
        </TouchableOpacity>
        <View>
          <View
            style={{
...
>>>>>>> nocirclesadface
        ...
        <Modal isVisible={this.state.isModalVisible} style={styles.modal}>
          <LogFormScreen log_type={4} on_finish={this.toggleModal} />
        </Modal>
      </View>
    );
  }
