...
export default class Settings extends Component {
  ...
  handle_icon_press = index => {
    ...
    this.setState({
      icon: index,
      isModalVisible_avatar: !this.state.isModalVisible_avatar
    });
  };
  ...
  toggleModal_birthday = () =>
    this.setState({
      isModalVisible_birthday: !this.state.isModalVisible_birthday
    });
  toggleModal_avatar = () =>
    this.setState({ isModalVisible_avatar: !this.state.isModalVisible_avatar });
  toggleModal_height = () =>
    this.setState({
      isModalVisible_height: !this.state.isModalVisible_height,
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
            ...
            <SettingsList.Item
              icon={
                <Image
                  ...
                  height={60}
                  resizeMode="contain"
                  source={require('../Resources/quicklog.png')}
                />
              }
              title="Quick Log"
              hasSwitch={true}
            ...
            <SettingsList.Item
              ...
              icon={
                <Image
                  ...
                  height={60}
                  resizeMode="contain"
                  source={require('../Resources/address-book.png')}
                />
              }
            />
            <SettingsList.Item
              icon={
                <Image
                  ...
                  height={60}
                  resizeMode="contain"
                  source={require('../Resources/faq.png')}
                />
              }
              title="Quick Log"
              title="FAQ"
        ...
        <Modal
          isVisible={this.state.isModalVisible_birthday}
          style={styles.modal}
        >
        ...
        <Modal
          isVisible={this.state.isModalVisible_height}
          style={styles.modal}
        >
        ...
        <Modal
          isVisible={this.state.isModalVisible_weight}
          style={styles.modal}
        >
          <View
            style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}
        ...
        <Modal isVisible={this.state.isModalVisible} style={styles.modal}>
          ...
          <Modal
            isVisible={this.state.isModalVisible_avatar}
            style={styles.modal}
          >
            <View
              style={{
