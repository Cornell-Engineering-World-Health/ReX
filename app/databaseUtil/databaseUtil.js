...
export function intializeDatabase () {
  ...
  Database.transaction(tx => {
    ...
    tx.executeSql('INSERT OR IGNORE INTO field_to_view_tbl (field_id,field_name,view_name) values (4, \'pillName\', \'TextInputType\')')
    ...
    tx.executeSql('INSERT OR IGNORE INTO field_to_view_tbl (field_id,field_name,view_name) values (6, \'startDate\', \'DatePicker\')')
    tx.executeSql('INSERT OR IGNORE INTO field_to_view_tbl (field_id,field_name,view_name) values (7, \'endDate\', \'DatePicker\')')
    tx.executeSql('INSERT OR IGNORE INTO field_to_view_tbl (field_id,field_name,view_name) values (8, \'time\', \'TextInputType\')')
    tx.executeSql('INSERT OR IGNORE INTO field_to_view_tbl (field_id,field_name,view_name) values (9, \'timeCategory\', \'TextInputType\')')
    tx.executeSql('INSERT OR IGNORE INTO field_to_view_tbl (field_id,field_name,view_name) values (10, \'daysOfWeek\', \'DayChooserInputType\')')
