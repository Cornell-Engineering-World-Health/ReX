...
createTables = function () {
  ...
  },err=> console.log(err),()=>console.log('creation success'))
}
intializeDatabase = function () {
  console.log('intializing database')
  Database.transaction(tx => {
    tx.executeSql('INSERT OR IGNORE INTO event_type_tbl (event_type_id,event_type_name,event_type_icon,card_field_id1,card_field_id2) values (1, \'headache\', \'image.png\',1,2)')
  ...
  },err=> console.log(err),()=>console.log('intialization success'))
